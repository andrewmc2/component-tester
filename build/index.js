...
var CurrencyConversion = function (_PureComponent) {
  _inherits(CurrencyConversion, _PureComponent);

  function CurrencyConversion() {
    _classCallCheck(this, CurrencyConversion);

    return _possibleConstructorReturn(this, (CurrencyConversion.__proto__ || Object.getPrototypeOf(CurrencyConversion)).apply(this, arguments));
  }
  ...
  _createClass(CurrencyConversion, [{
    ...
    value: function render() {
      var _props = this.props,
          ...
          valueOnly = _props.valueOnly,
          precision = _props.precision,
          commas = _props.commas,
          minDecimals = _props.minDecimals;

      return _react2.default.createElement(
        'span',
        { className: className || '' },
        (0, _conversions2.default)({ fromCurrency: from, targetCurrency: to, value: value, valueOnly: valueOnly, commas: commas, precision: precision, minDecimals: minDecimals })
      );
    }
  }]);
...
CurrencyConversion.propTypes = {
  ...
  from: _propTypes.PropTypes.oneOf(['Satoshi', 'BTC', 'mBTC']).isRequired,
  to: _propTypes.PropTypes.oneOf(['Satoshi', 'BTC', 'mBTC']).isRequired,
  valueOnly: _propTypes.PropTypes.bool,
  commas: _propTypes.PropTypes.bool,
  value: _propTypes.PropTypes.number.isRequired,
  precision: _propTypes.PropTypes.number,
  minDecimals: _propTypes.PropTypes.number
};
...
exports.getMinDecimals = exports.getDisplayPrecision = exports.getSatoshiPrecision = undefined;
exports.default = convert;
exports.applyPrecision = applyPrecision;
exports.getMultiplier = getMultiplier;
exports.roundToMBTC = roundToMBTC;
...
function convert(params) {
  var fromCurrency = params.fromCurrency,
      targetCurrency = params.targetCurrency,
      value = params.value,
      _params$valueOnly = params.valueOnly,
      valueOnly = _params$valueOnly === undefined ? false : _params$valueOnly,
      _params$commas = params.commas,
      commas = _params$commas === undefined ? false : _params$commas,
      _params$precision = params.precision,
      precision = _params$precision === undefined ? 3 : _params$precision,
      _params$toString = params.toString,
      toString = _params$toString === undefined ? true : _params$toString,
      minDecimals = params.minDecimals;

  var finalValue = void 0;
  var multiplier = getMultiplier(targetCurrency, fromCurrency);
  ...
  var currency = '';
  if (!valueOnly) {
    var formattedCurrency = targetCurrency.toUpperCase();
    if (targetCurrency.length === 4) {
      formattedCurrency = _lodash2.default.lowerFirst(formattedCurrency);
    }
...
function getMultiplier(to) {
  var from = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 'Satoshi';
...
function roundToMBTC(satoshiValue) {
...
var MIN_BTC_DECIMALS = 5;
var MIN_MBTC_DECIMALS = 2;

var getSatoshiPrecision = exports.getSatoshiPrecision = function getSatoshiPrecision(min) {
  return -String(min).length + 1;
};

var getDisplayPrecision = exports.getDisplayPrecision = function getDisplayPrecision(min, currency) {
  var satoshiPrecision = getSatoshiPrecision(min);
  return currency === 'BTC' ? satoshiPrecision + 8 : satoshiPrecision + 5;
};

var getMinDecimals = exports.getMinDecimals = function getMinDecimals(currency, precision) {
  return currency === 'BTC' ? Math.max(precision, MIN_BTC_DECIMALS) : Math.max(precision, MIN_MBTC_DECIMALS);
};
...
var _currencyConversion = __webpack_require__(6);

var _currencyConversion2 = _interopRequireDefault(_currencyConversion);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

module.exports = {
  Chip: _chip.Chip,
  ChipContainer: _chip.ChipContainer,
  CurrencyConversion: _currencyConversion2.default
};
...
module.exports = {
  convert: _conversions2.default,
  applyPrecision: _conversions.applyPrecision,
  getMultiplier: _conversions.getMultiplier,
  roundToMBTC: _conversions.roundToMBTC,
  getDecimalPlaces: _conversions.getDecimalPlaces,
  getSatoshiPrecision: _conversions.getSatoshiPrecision,
  getDisplayPrecision: _conversions.getDisplayPrecision,
  getMinDecimals: _conversions.getMinDecimals,
  addCommas: _conversions.addCommas
};
...
var ChipIcon = exports.ChipIcon = function (_PureComponent) {
  _inherits(ChipIcon, _PureComponent);

  function ChipIcon() {
    _classCallCheck(this, ChipIcon);

    return _possibleConstructorReturn(this, (ChipIcon.__proto__ || Object.getPrototypeOf(ChipIcon)).apply(this, arguments));
  }
  ...
  _createClass(ChipIcon, [{
    ...
    value: function render() {
      var _props = this.props,
          ...
          primaryCheckerColor = _props.primaryCheckerColor,
          secondaryCheckerColor = _props.secondaryCheckerColor,
          borderGradientColorOne = _props.borderGradientColorOne,
          borderGradientColorTwo = _props.borderGradientColorTwo,
          opacity = _props.opacity;


      var borderGradientId = id + '_borderGradient';
      var borderId = id + '_border';
      var checkerBorderId = id + '_checkerBorder';
      var chipGleamGradientId = id + '_chipGleam';

      return _react2.default.createElement(
        'svg',
        { width: '100%', height: '100%', viewBox: '0 0 23 23', xmlns: 'http://www.w3.org/2000/svg', xmlnsXlink: 'http://www.w3.org/1999/xlink' },
        _react2.default.createElement(
          'defs',
          null,
          _react2.default.createElement(
            'linearGradient',
            { x1: '50%', y1: '0%', x2: '50%', y2: '100%', id: borderGradientId },
            _react2.default.createElement('stop', { stopColor: borderGradientColorOne, offset: '0%' }),
            _react2.default.createElement('stop', { stopColor: borderGradientColorTwo, offset: '100%' })
          ),
          _react2.default.createElement(
            'mask',
            { id: borderId, x: '-2', y: '-2', width: '22.564', height: '22.518' },
            _react2.default.createElement('path', { fill: '#fff', d: 'M1.356 1.356H23.92v22.518H1.356z' }),
            _react2.default.createElement('ellipse', { cx: '12.638', cy: '12.615', rx: '9.282', ry: '9.259' })
          ),
          _react2.default.createElement(
            'mask',
            { id: checkerBorderId, fill: '#fff' },
            _react2.default.createElement('ellipse', { cx: '12.638', cy: '12.615', rx: '9.282', ry: '9.259' })
          ),
          _react2.default.createElement(
            'linearGradient',
            { id: chipGleamGradientId, x1: '27.409%', y1: '119.745%', x2: '50%', y2: '100%' },
            _react2.default.createElement('stop', { stopColor: '#FFF', stopOpacity: '0', offset: '0%' }),
            _react2.default.createElement('stop', { stopColor: '#FFF', offset: '100%' })
          )
        ),
        _react2.default.createElement(
          'g',
          { transform: 'translate(-1 -1)', fill: 'none', fillRule: 'evenodd' },
          _react2.default.createElement('circle', { fill: '#068D51', cx: '12.5', cy: '12.5', r: '10.5' }),
          _react2.default.createElement(
            'g',
            { opacity: opacity },
            _react2.default.createElement('ellipse', { fill: secondaryCheckerColor, cx: '12.638', cy: '12.615', rx: '9.282', ry: '9.259' }),
            _react2.default.createElement('ellipse', { stroke: 'url(#' + borderGradientId + ')', mask: 'url(#' + borderId + ')', strokeWidth: '4', cx: '12.638', cy: '12.615', rx: '9.282', ry: '9.259' }),
            _react2.default.createElement('path', { fill: primaryCheckerColor, mask: 'url(#' + checkerBorderId + ')', d: 'M2.261 10.66h20.837v3.838H2.261z' }),
            _react2.default.createElement('path', { fill: primaryCheckerColor, mask: 'url(#' + checkerBorderId + ')', transform: 'rotate(60 12.656 12.92)', d: 'M2.237 11h20.837v3.838H2.237z' }),
            _react2.default.createElement('path', { fill: primaryCheckerColor, mask: 'url(#' + checkerBorderId + ')', transform: 'scale(-1 1) rotate(60 0 -9.002)', d: 'M2.237 11h20.837v3.838H2.237z' }),
            _react2.default.createElement('ellipse', { fill: fillColor, cx: '12.585', cy: '12.585', rx: '7.178', ry: '7.178' }),
            _react2.default.createElement('path', { d: 'M19.674 12.99c-.083-5.014-4.183-9.052-9.228-9.052-5.046 0-9.146 4.038-9.23 9.051h18.458z', fill: 'url(#' + chipGleamGradientId + ')', style: { mixBlendMode: 'soft-light' }, transform: 'rotate(-28 10.446 8.464)' })
          )
        )
      );
    }
...
ChipIcon.propTypes = {
  ...
  fillColor: _propTypes.PropTypes.string.isRequired,
  primaryCheckerColor: _propTypes.PropTypes.string.isRequired,
  secondaryCheckerColor: _propTypes.PropTypes.string.isRequired,
  borderGradientColorOne: _propTypes.PropTypes.string.isRequired,
  borderGradientColorTwo: _propTypes.PropTypes.string.isRequired,
  opacity: _propTypes.PropTypes.string
};
...
var _chipIcon = __webpack_require__(13);
...
var ForegroundDefault = _styledComponents2.default.div(_templateObject);

var Foreground = ForegroundDefault.extend(_templateObject2);

var ForegroundRight = ForegroundDefault.extend(_templateObject3);

var ForegroundTableDefault = _styledComponents2.default.div(_templateObject4);

var ForegroundTableRight = ForegroundTableDefault.extend(_templateObject5);

var ChipContainer = _styledComponents2.default.div(_templateObject6, function (props) {
...
var Chip = function (_PureComponent) {
  ...
  function Chip(props) {
    ...
    _this.state = {
      isMobile: !_lodash2.default.isNull(md.mobile())
    };
    return _this;
  }
  ...
  _createClass(Chip, [{
    ...
    value: function render() {
      var _props = this.props,
          ...
          isOnTable = _props.isOnTable,
          showValue = _props.showValue,
          chipStyleKey = _props.chipStyleKey,
          opacity = _props.opacity;

      var valueLeft = '50%';
      var valueColor = textColor || '#fff';
      var chipContent = align === 'right' ? ForegroundRight : Foreground;
      var chipValueStyle = { left: valueLeft, color: valueColor };
      if (isOnTable) {
        var colors = {
          blue: '#1d7ac7',
          red: '#ca354b',
      ...
      return _react2.default.createElement(
        ChipContainer,
        { className: 'chip', size: size, transform: isOnTable && this.state.isMobile ? 'transform: scale(0.8)' : null },
        _react2.default.createElement(_chipIcon.ChipIcon, _extends({ id: id + '_icon' }, CHIP_STYLES[chipStyleKey], { opacity: opacity })),
        _react2.default.createElement(chipContent, { style: chipValueStyle }, [!!valuePrefix && _react2.default.createElement(
          'span',
          { key: 'chip-label' },
          valuePrefix
        ), !!value && showValue && _react2.default.createElement(_currencyConversion2.default, { key: 'chip-value', to: currency, value: value, valueOnly: true })])
      );
    }
  }]);
...
Chip.propTypes = {
  id: _propTypes.PropTypes.string.isRequired,
  currency: _propTypes.PropTypes.oneOf(['BTC', 'mBTC', 'Satoshi']),
  value: _propTypes.PropTypes.number,
  valuePrefix: _propTypes.PropTypes.string,
  size: _propTypes.PropTypes.number,
  align: _propTypes.PropTypes.string,
  border: _propTypes.PropTypes.bool,
  active: _propTypes.PropTypes.bool,
  textColor: _propTypes.PropTypes.string,
  isOnTable: _propTypes.PropTypes.bool,
  showValue: _propTypes.PropTypes.bool,
  chipStyleKey: _propTypes.PropTypes.oneOf(Object.keys(CHIP_STYLES)).isRequired,
  opacity: _propTypes.PropTypes.string
};
